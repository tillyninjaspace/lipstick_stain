...
const About = () => {
    ...
    return (
        <div>
            <h1>About Lipstick Stain</h1>
            <p>Before I moved to the San Luis Obispo County area, I wasn't a wine enthusiast. With hundreds of wineries
                in the area here surrounded by a lot of farm land, the easy access of getting wine straight from the source 
                in this environment is a gift so I started an adventure of wine tasting. At first, I wasn't sure if I'll fit in as a stay at home mom who 
            ...
            <p>There is a unique culture here. It's laid back like where I grew up in San Diego but much more rural with 
                beautiful hills and beaches that just all exist in one county. Sometimes I'd be at the beach and see both
                in one take. It's a true sanctuary for those who need  it.
            </p>
            ...
            <h3>Discovery</h3>
            <p>Even as a native Californian, before I started my life here, I had generalized and thought that everything north of California is like the bay area
                but San Luis Obispo County is not like Northern California. It is the Central Coast of Calfornia and so much slower
                paced than the big cities north or south of this county. We have an abundant of food and drink that is grown
