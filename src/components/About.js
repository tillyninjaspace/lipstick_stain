    ...
    return (
        ...
        <div className="aboutSection" style={{padding: "1em"}}> 
            ...
            <p>I became a wine enthusiast after moving to the San Luis Obispo (SLO) County area. With hundreds of wineries
                ...
                in this environment is a gift so I started an adventure of wine tasting. At first, I wasn't sure if I'd fit in. I went to my first winery with an expectation that it was going
            ...
            <p>Even as a native Californian, I was oblivious to the bliss of the Central Coast of California. It's so much slower
                paced than the big cities north or south (where I came from) of this county. We have an abundant of food and drink that is grown
