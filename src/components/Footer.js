...
const Footer = ({isChanged, setIsChanged, token, setToken}) => {
    ...
    return (
        <div className="footer"> 
            ...
            <span className="socialMedia">Follow Us on Instagram &nbsp;</span>
            ...
            <p className="footerLinks">
               ...
               : ""}
                ...
                author using React,
                PostgreSQL, Node, Express and Multer/Cloudinary.
                </p>
                ...
                <p>You must be 21 years old and older to drink wine in the area and in the U.S.A. Please drink responsibly and use a transportation service when it's unsafe to drive.</p>
